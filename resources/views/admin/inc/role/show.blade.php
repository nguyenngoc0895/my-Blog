...
<section class="content-header">
    ...
    <div class="row mb-2">
        ...
        <a class="col-lg-offset-4 btn btn-success" href="{{ route('role.create')}}">Add new role</a>
        </div>
    </div>
    </div><!-- /.container-fluid -->
</section>
            ...
            <tbody>
                @foreach ($roles as $role)
                    <tr>
                        <td>{{ $loop->index + 1}}</td>
                        <td>{{ $role->name }}</td>
                        <td><a href="{{ route('role.edit', $role->id) }}"><ion-icon name="create"></ion-icon></span></a></td>
                        <td>
