...
<section class="content-header">
    ...
    <div class="row mb-2">
        ...
        <a class="col-lg-offset-4 btn btn-success" href="<?php echo e(route('role.create')); ?>">Add new role</a>
        </div>
    </div>
    </div><!-- /.container-fluid -->
</section>
            ...
            <tbody>
                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><a href="<?php echo e(route('role.edit', $role->id)); ?>"><ion-icon name="create"></ion-icon></span></a></td>
                        <td>
